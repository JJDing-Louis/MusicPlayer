...
namespace ControlLibrary
{
    ...
    public partial class ucComboBox : UserControl
    {
        ...
        public ucComboBox()
        {
            ...
            //ComboBox: Dropdown list(預設值)
            cmbList.Dock = DockStyle.Fill;
            cmbList.Margin = new Padding(8, 0, 0, 0);
            cmbList.BackColor = listBackColor; //預設亮綠色
            ...
            base.BackColor = borderColor; //Border Color(紫色)
            this.ResumeLayout();
